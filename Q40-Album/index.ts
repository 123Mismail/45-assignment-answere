...
function person_bio(name:string,age:number,gender?:string){

    const personDetail:{name:string ,age:number ,gender?:string}={
        name: name,
        age: age,
  ...
  function student_detail(name:string,rollNo:number,inClass:number,isPass:boolean,nationality ?:string){

    const student_results:{name:string,rollNo:number,inClass:number,isPass:boolean,nationality?:string} ={
