"use strict";
// Stages of Life: Write an if-else chain 
// that determines a person’s stage of life. Set a value for the variable age, 
// and then
let personAge = 2; // in years
...
// print a message that the person is an adult.
    ...
    console.log(` person is an adault .`);
}
//• If the person is age 65 or older,
// print a message that the person is an elder.
else if (personAge > 65) {
    console.log(` person is an elder man.`);
}
else {
    console.log(` please select a right age`);
}
